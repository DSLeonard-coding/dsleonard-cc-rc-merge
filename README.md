# dsleonard-cc-rc-merge
> Merges json data to .cookiecutterrc file  
...
```bash
uv tool install "git+https://github.com/DSLeonard-coding/dsleonard-cc-rc-merge.git"
dsleonard-cc-rc-merge
```

To use ssh (if this is a private project) use:
```bash
uv tool install "git+ssh://git@github.com/DSLeonard-coding/dsleonard-cc-rc-merge.git"
```

If want to use libraries provided by the application...

### Use in your custom library or app
To use dsleonard-cc-rc-merge in a python program, cd to your working directory or project directory, if it's already a  project, and just do:
```bash
uv add "dsleonard-cc-rc-merge @ git+https://github.com/DSLeonard-coding/dsleonard-cc-rc-merge.git"
...
```bash
uv add --script myscript.py "dsleonard-cc-rc-merge @ git+https://github.com/DSLeonard-coding/dsleonard-cc-rc-merge.git"
