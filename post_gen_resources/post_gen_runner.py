...
repo_name = "dsleonard-cc-rc-merge"
description = "Merges json data to .cookiecutterrc file"
...
project_pkg = "dsleonard_cc_rc_merge"
show_repo = True
main_proj_dir = ""
...
def main():
    ...
    cc_data = json.loads(r'{    "__executable_name": "dsleonard-cc-rc-merge",    "__repo_slug": "dsleonard-cc-rc-merge",    "_checkout": null,    "_copy_without_render": [        ".github/workflows/*",        ".github/*",        "post_gen_resources/src/*",        "post_gen_resources/.venv",        "post_gen_resources/.setup_env",        ".*env",        ".idea/*"    ],    "_dsleonard_cc_rc_merge_path": "/home/osboxes/repos/dsleonard-cc-rc-merge/",    "_dsleonard_git_tools_path": "/home/osboxes/repos/dsleonard-git-tools/",    "_exclude_from_rc": [        "project_name",        "project_pkg",        "overwrite_repo",        "description"    ],    "_output_dir": "/home/osboxes/repos",    "_repo_dir": "/tmp/cookiecutterbw5khiw_/pylaunch",    "_template": "pylaunch",    "_use_local_deps": false,    "author_email": "dleonard.dev@gmail.com",    "author_name": "Douglas Leonard",    "auto_push_new_repo": true,    "create_wiki_page": true,    "description": "Merges json data to .cookiecutterrc file",    "install_command_entry_point": true,    "license": "MIT, attribution required",    "make_repo_public": false,    "overwrite_repo": "YES",    "project_name": "dsleonard-cc-rc-merge",    "project_pkg": "dsleonard_cc_rc_merge",    "python_version": "3.10",    "repo": "github.com",    "repo_namespace": "DSLeonard-coding",    "repo_type": "github"}')
